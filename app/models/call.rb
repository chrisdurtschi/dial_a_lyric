class Call < ActiveRecord::Base
  ...
  validates_presence_of :from_name, :from_number, :from_number_country_prefix
  validates_presence_of :to_name, :to_number, :to_number_country_prefix
  validates_presence_of :voice, :lyric
